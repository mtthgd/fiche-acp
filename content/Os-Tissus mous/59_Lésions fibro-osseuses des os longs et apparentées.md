...
# Lésions fibro-osseuses des os longs et apparentées

> Liens : [[44_Tumeurs ostéoformatrices bénignes]] | [[55_Autres lésions riches en cellules géantes]] | [[43_Lésions kystiques osseuses]] | [[40_Introduction à la pathologie osseuse tumorale - démarche diagnostique]]

## Objectifs

- Différencier **dysplasie fibreuse** d'un **ostéosarcome de bas grade**
- Différencier **dysplasie fibreuse** d'une **ostéofibrodysplasie**
- Différencier **ostéofibrodysplasie** d'un **adamantinome**
- Connaître les **deux types d'adamantinome** et le **continuum** OFD ↔ adamantinome
- Connaître les anomalies moléculaires (**GNAS** pour la dysplasie fibreuse)
...
## Généralités
- Lésion **fibro-osseuse bénigne intramédullaire**
- Formes : **monostotique** (1 os) ou **polyostotique** (plusieurs os)
- **2,5%** des tumeurs osseuses, **7%** des tumeurs bénignes
- Sex-ratio 1:1, tous âges
- Topographie :
...
- Révélation : douleur, **fracture pathologique**
- Forme polyostotique : **déformations**, **asymétrie faciale**, atteintes sensorielles (visuelle, auditive, olfactive)

### Syndromes associés
- **Syndrome de McCune-Albright** : dysplasie fibreuse polyostotique + endocrinopathies multiples + pigmentations cutanées (taches café-au-lait)
...
- **Lacune** intramédullaire avec aspect **en verre dépoli**
- **Bordure d'ostéosclérose** fréquente
- **Calcifications centrales** (possible DD tumeur cartilagineuse)
- Corticale adjacente **épaissie** ou **érodée** en interne
- Aspect **multiloculaire** fréquent
...
- Macro : tissu **ferme**, gris jaunâtre, parfois kystique, foyers cartilagineux possibles
- Microscopie : **lésion fibro-osseuse** en proportions variables :
  - **Travées osseuses immatures**, incurvées, en **lettres alphabétiques** ("alphabet soup")
  - **Absence** d'ourlet ostéoblastique (sauf traumatisme)
...
- Mutations **GNAS** (petite sous-unité α de la protéine G activatrice)
- Hotspots : **R201H** / **R201C**
...
- **Excellent**
- Déformations dans formes polyostotiques
- **Transformation maligne exceptionnelle (< 1%)** : le plus souvent ostéosarcome

## DD principal : ostéosarcome de bas grade

- Outil : **amplification MDM2** (+)
- Contexte radio-clinique : **tumeur de surface** plus fréquente

---

# 2. Ostéofibrodysplasie (OFD, maladie de Campanacci)

## Généralités
- Lésion **fibro-osseuse bénigne**, **intracorticale, partie antérieure/médiane du tibia**
- Incidence probablement sous-estimée (souvent asymptomatique), **< 1%**
- Enfants / adolescents **< 15 ans**
- Si présente > 15 ans → se méfier d'un **adamantinome type OFD**
...
- Déformation peut persister
- **Chirurgie** uniquement si : déformation importante, fracture, douleurs

---

# 3. Adamantinome

## Continuum OFD ↔ Adamantinome

| Entité | Âge | Contingent épithélial |
|--------|-----|----------------------|
| **OFD** (bénin) | < 15 ans | Cellules **isolées, dispersées** |
...
- Âge moyen **25-35 ans** (possible dès 3 ans), discrète prédominance masculine
- **0,4%** des tumeurs osseuses, très rare
- Nombreuses similitudes épidémiologiques, radiologiques, morphologiques et génétiques avec l'OFD

## Imagerie
- Comparable à l'OFD mais **plus étendue**
- Partie antérieure de la métaphyse et diaphyse **du tibia dans 85-90%**
- Aspect **hétérogène**, ostéolytique, excentrée, multiloculée
- Extension intramédullaire et/ou aux tissus mous possible
...
**4 patterns** du contingent épithélial :
1. **Basaloïde**
2. **Tubuleux**
3. **À cellules fusiformes** (formes récidivantes, métastases)
4. **Épidermoïde**

Contingent **ostéofibreux** associé :
- Travées osseuses matures bordées de **cellules ostéoblastiques proéminentes**
...
| Marqueur | Résultat |
|----------|----------|
| **Cytokératines basales** (CK5/6, CK14, CK19) | + |
| EMA | + |
| Vimentine | + |
| **p63** | + |
| Podoplanine | + |
...
## Génétique / étiopathogénie

- **Anomalies numériques récurrentes** des chromosomes **7, 8, 12, 19, 21**
- **Gradient de complexité** : OFD < adamantinome type OFD < adamantinome classique
- **Chromosome 19** altéré dans l'adamantinome mais pas dans l'OFD (sauf DD)

### Hypothèses pathogéniques
1. OFD = lésion **précurseur** de l'adamantinome
...
- **Récidive** : 90% si résection incomplète
- **Métastases** : 12-30% (uniquement forme classique)

## Diagnostics différentiels de l'adamantinome

| DD | Distinction |
|----|-------------|
| **Ostéofibrodysplasie** | Cellules épithéliales **isolées** (vs amas) — IHC AE1/AE3 |
| **Dysplasie fibreuse** | Mutation **GNAS** |
| **Ostéosarcome de bas grade** | **Amplification MDM2** |
...
1. **Dysplasie fibreuse** : intramédullaire, **pas d'ourlet ostéoblastique**, travées en "lettres alphabétiques", mutation **GNAS** (R201H/C)
2. **Syndrome de McCune-Albright** = DF polyostotique + endocrinopathies + pigmentations ; **Mazabraud** = DF + myxome(s) intramusculaire(s)
3. **Ostéofibrodysplasie (OFD)** : enfant < 15 ans, **intracorticale tibia antérieur**, **architecture zonale**, cellules **AE1/AE3 isolées**
4. **Adamantinome** : tumeur **maligne** ostéofibreuse + **contingent épithélial**, tibia +++ (85-90%)
5. **Continuum OFD → adamantinome type OFD (bas grade) → adamantinome classique** (haut grade)
6. OFD : cellules AE1/AE3 **isolées** ; adamantinome type OFD : **amas** ; adamantinome classique : **contingent épithélial majeur**
7. Patterns de l'adamantinome classique : basaloïde, tubuleux, fusiforme, épidermoïde
8. IHC : cytokératines **basales** (CK5/6, 14, 19), p63+, podoplanine+, CK8/18 **−**
9. Pronostic adamantinome : **récidive 90%** si exérèse incomplète, **métastases 12-30%** (forme classique)
10. DD critique : **dysplasie fibreuse** (GNAS) vs **ostéosarcome bas grade** (**MDM2 amplifié**) vs OFD/adamantinome (**continuum**, IHC cytokératines)
