---
tags: [anatomopathologie, ACP, tissu_mou, differenciation_incertaine, sarcome_alveolaire_tissus_mous, ASPSCR1_TFE3, sarcome_cellules_claires, EWSR1_ATF1, rhabdoid, PEComa, DSRCT]
date: 2024
source: DES ACP - Cours d'appareil locomoteur et tissus mous
---

# Sarcomes de différenciation incertaine (2)

> Liens : [[101_Sarcomes de différenciation incertaine (1) - Synovialosarcome, sarcome épithélioïde]] | [[81_Classification moléculaire]] | [[70_Tumeurs vasculaires (os et tissus mous)]] | [[80_CAT TM]]

## Généralités

Sarcomes **rares** classés dans les sarcomes de **différenciation incertaine** (OMS 2020). Caractéristiques morpho-IHC-moléculaires spécifiques permettant souvent le diagnostic. **Tumeurs monomorphes** (pas de pléomorphisme) → toujours évoquer un **sarcome à translocation**.

Entités abordées :
1. **Sarcome alvéolaire des parties molles** (ASPS)
2. **Tumeur desmoplasique à petites cellules rondes** (DSRCT)
3. **Sarcome à cellules claires**
4. **Chondrosarcome myxoïde extrasquelettique**
...
### Généralités
- **< 1% des sarcomes**
- **Adolescents et adultes jeunes**, **prédominance féminine**
- **Cuisse intramusculaire** (siège préférentiel, profond)
- Évolution lente mais **métastases fréquentes** (parfois révélatrices tardives) : **poumon, cerveau, os**
- **Survie à 5 ans ~20%**
...
- **Vascularisation endocrine** : capillaires fins séparant les nids
- **Cellules monomorphes** (atypies sans pléomorphisme), **grande taille**
- Cytoplasme **éosinophile**, noyau volumineux ovale, chromatine **vésiculeuse**, **nucléole central proéminent**
- **Mitoses peu fréquentes**
...
- **Translocation t(X;17)** → fusion **ASPSCR1–TFE3**
...
## 2. Sarcome à cellules claires ("mélanome des parties molles")

### Généralités
- **< 1% des sarcomes**, **adolescents/adultes jeunes**
- Localisation : **extrémités distales**, au **contact de tendons/aponévroses**
...
- Cytoplasme **clair** (d'où le nom), abondant, éosinophile pâle
- Noyau volumineux, chromatine vésiculeuse, **nucléole central éosinophile**
- **Pas de pléomorphisme** (cellules monomorphes)
- Mitoses peu fréquentes
- **Septa fibreux**
...
- Non spécifique (aussi dans **histiocytofibrome angiomatoïde**, etc.)
...
## 3. Tumeur desmoplasique à petites cellules rondes (DSRCT)

### Généralités
- **< 1% des sarcomes**
- **Enfant/adolescent**, **prédominance masculine**
...
| DD | Distinction |
|----|-------------|
| **Sarcome d'Ewing** | IHC (pas desmine/WT1), autre translocation |
| **Rhabdomyosarcome** | Desmine + (mais **pas de cytokératines**) |
| **Carcinome neuroendocrine** | Pas de desmine, contexte improbable |
...
### Généralités
- Nom **trompeur** : ne présente **pas de différenciation cartilagineuse** réelle (rappel : pas de chondrosarcome conventionnel dans TM)
- **Adulte d'âge moyen**, **prédominance masculine**
...
- Fond **peu vascularisé** (≠ liposarcome myxoïde)
- **Signe des "cellules qui se donnent la main"** : cellules en contact par leur cytoplasme (non vu dans les autres tumeurs myxoïdes)
- Cellules épithélioïdes ou fusiformes, **noyau monomorphe pâle**, membrane nucléaire bien visible, petit nucléole
...
| DD | Distinction |
|----|-------------|
| **Tumeur mixte / myoépithéliome** | IHC non discriminante, **EWSR1+ possible** → **partenaire de fusion différent** |
| **Myxofibrosarcome** | **Pléomorphe** (ici monomorphe) |
...
| Sarcome | Âge | Siège | Morphologie | IHC clé | Translocation |
|---------|-----|-------|-------------|---------|---------------|
| **ASPS** | Ado/jeune adulte, F | Cuisse profonde | Alvéolaire, vasc. endocrine, cristaux PAS+ | **TFE3+++** | **t(X;17) ASPSCR1–TFE3** |
| **Sarcome cell. claires** | Ado/jeune adulte | Extrémités, tendons | Nids, cytoplasme clair | **Mélanocytaires + (S100, HMB45, Melan-A, SOX10)** | **t(12;22) EWSR1–ATF1** |
...
1. **Tous monomorphes** (pas de pléomorphisme) → évocateur de **sarcome à translocation**, plus fréquent chez le **sujet jeune**
2. **ASPS** : **architecture alvéolaire + vasc. endocrine + cristaux PAS+ + TFE3 nucléaire +++** ; fusion **ASPSCR1–TFE3**
3. ASPS : évolution lente mais **métastases tardives fréquentes** (poumon, cerveau, os) ; forme pédiatrique tête-cou = bon pronostic
4. **Sarcome à cellules claires** = "mélanome des parties molles" — extrémités distales, tendons, marqueurs mélanocytaires + ; **EWSR1–ATF1**
5. Différencier **sarcome cellules claires vs mélanome** : **PAS de remaniement EWSR1 dans le mélanome**
6. **DSRCT** : enfant/ado, intra-abdominal, petites cellules rondes + **stroma desmoplasique**, **différenciation polyphénotypique** (desmine + CK + EMA + WT1)
7. **WT1 dans DSRCT** : anticorps dirigé contre la **partie C-terminale**
8. **Chondrosarcome myxoïde extrasquelettique** : nom trompeur (pas de cartilage), architecture **réticulée, cellules "se donnant la main"**, fond myxoïde peu vascularisé
9. Plusieurs sarcomes partagent un remaniement **EWSR1** (sarcome cell. claires, DSRCT, chondrosarcome myxoïde, Ewing, myoépithéliome…) → **rechercher le partenaire** ou **NR4A3** si suspicion de chondrosarcome myxoïde
10. **Diagnostic = convergence** des données cliniques + topographie + morphologie + IHC + moléculaire (ne jamais conclure sur la moléculaire seule)
