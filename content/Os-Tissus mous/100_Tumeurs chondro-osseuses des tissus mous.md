---
tags: [anatomopathologie, ACP, tissu_mou, tumeur_chondro_osseuse_TM, chondrome_tissus_mous, osteosarcome_extra_osseux, chondrosarcome_mesenchymateux, myositique_ossifiante]
date: 2024
source: DES ACP - Cours d'appareil locomoteur et tissus mous
---

# Tumeurs chondro-osseuses des tissus mous

> Liens : [[45_Tumeurs ostéoformatrices malignes (ostéosarcomes)]] | [[48_Chondrosarcomes]] | [[52_Autres tumeurs cartilagineuses]] | [[92_Fasciite nodulaire, myosite ossifiante, fibromatoses]]

## Généralités

Deux grands groupes abordés :
1. **Lésions cartilagineuses des tissus mous** (dont le **chondrome**)
2. **Lésions ostéoformatrices** (dont l'**ostéosarcome extra-squelettique**)

**Démarche diagnostique en 2 étapes** :
1. Reconnaître la matrice (cartilagineuse ou ostéoïde)
2. **Éliminer une origine osseuse** par l'imagerie (radio, scanner, échographie des extrémités) → documents essentiels


---

## Partie 1 : Lésions cartilagineuses des tissus mous

### Liste des entités
- **Chondrome des tissus mous**
- Chondromatose synoviale
- Ostéosarcome extra-squelettique chondroblastique
- **Chondrosarcome mésenchymateux** (forme rare)
- Tumeurs avec chondrogenèse hétérologue

### Reconnaissance du cartilage
...
### Définition (OMS)
**Tumeur bénigne à différenciation cartilagineuse dont le siège n'est ni osseux, ni synovial** (définition par la négative → imagerie indispensable).

### Épidémiologie / Clinique
- **1,5% des lésions bénignes des TM** (plus rare que l'enchondrome)
- Âge très variable (enfant → 4e âge), moyenne **~35 ans**
- Localisation : **extrémités +++, > 2/3 aux doigts**, orteils, main, pied
- **Petite taille (1-2 cm)**
...
- **Calcifications périphériques** et début d'ossification fréquents
...
|---------|---------------|
| **Cellulaire** | Matrice très peuplée, logettes anarchiques, binucléations, anisonucléose — **mimerait un chondrosarcome dans l'os** |
| **Myxoïde** | Matrice myxoïde |
| **Kystique** | Fréquent |
...
### Biologie moléculaire (récente)
- **Translocation t(2;?)** impliquant **FN1–FGFR2** (~2/3 des cas)
...
| DD | Distinction |
|----|-------------|
| **Chondromatose synoviale** | Plus cellulaire, groupes isogéniques groupés en lobules (**aspect de lobulation**), anisonucléose ↑, grosses articulations (mais extrémités possibles) |
...
## Partie 2 : Lésions ostéoformatrices des tissus mous
...
2. **Éliminer une origine osseuse** (imagerie ++)
...
### Épidémiologie
- **< 2% des sarcomes des TM** et **< 5% des ostéosarcomes**
- Âge **plus tardif** que l'ostéosarcome primitif osseux : **moyenne 50 ans** (23-82 ans)
- Localisation : intramusculaire **profond** — cuisse, fesse, épaule, pénis
- Peut survenir en **territoire irradié**

### Histologie
- **Strictement superposable** à l'ostéosarcome intraosseux
...
- Facteurs favorables : petite taille, siège superficiel, exérèse satisfaisante, sujet jeune, lésions avec composante de bas grade
...
## Arbre diagnostique — Lésion maligne avec ostéoformation

| Siège | Évoquer |
|-------|---------|
| **Viscéral** | Carcinome, carcinosarcome |
| **Glande salivaire** | Tumeur mixte maligne |
| **TM (profond)** | **Liposarcome dédifférencié** → rechercher composante lipoma-like + **MDM2+ IHC** |
...
1. **Démarche = 2 étapes** : identifier la matrice + **éliminer origine osseuse par l'imagerie**
2. **PS100** marque diffusément la matrice cartilagineuse (utile si myxoïde)
3. **Chondrome des TM** : extrémités +++ (doigts), petite taille, bien limité, hyalin + calcifications périphériques ; **très bien différencié**
4. **PAS de chondrosarcome conventionnel dans les TM** — une lésion "cellulaire atypique" reste un chondrome
5. DD majeur : **chondromatose synoviale** (aspect de lobulation), enchondrome/chondrome périosté (imagerie)
6. **Chondrome = translocation FN1-FGFR2** dans ~2/3 des cas (récemment décrite)
7. **Matrice ostéoïde** = **diagnostic morphologique pur** (pas d'IHC spécifique) — attention aux mimétismes (fibrosarcome, rhabdomyosarcome sclérosant)
8. Devant ostéoformation maligne : écarter **liposarcome dédifférencié (MDM2+)**, **MPNST (H3K27me3)**, carcinomes/carcinosarcomes, tumeurs mixtes
9. **Ostéosarcome extra-squelettique** = sujet âgé (50 ans), profond, mauvais pronostic (< 50% à 5 ans), **diagnostic d'exclusion**
10. **Lésions réactionnelles** (myosite ossifiante) peuvent être très inquiétantes au stade initial → toujours s'en méfier
