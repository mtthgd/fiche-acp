---
tags: [anatomopathologie, ACP, tissu_mou, schwannome, neurofibrome, perineuriome, NF1, NF2, SOX10, S100, EMA, GLUT1, neurofibromatose]
date: 2024
source: DES ACP - Cours d'appareil locomoteur et tissus mous
---

# Tumeurs bénignes de la gaine des nerfs

> Liens : [[99_Tumeurs malignes des gaines des nerfs (MPNST)]] | [[80_CAT TM]] | [[90_Tumeurs adipeuses bénignes]]

## Généralités

Quatre entités bénignes constituées de cellules de type schwannien :
- **Schwannome**
- **Neurofibrome**
- **Périneuriome** (cellules périneurales)
- **Tumeur à cellules granuleuses**

Les **tumeurs nerveuses hybrides** (OMS 2013) combinent schwannome/périneuriome ou schwannome/neurofibrome dans une même lésion (aspect biphasique).
...
- Tumeur **fréquente et bénigne**, tout âge
- **Solitaire sporadique** le plus souvent
- Formes **multiples syndromiques** : NF2 (**schwannomes vestibulaires bilatéraux**), schwannomatose, complexe de Carney (schwannomes mélanocytiques)
...
- **Zones Antoni A** : zones cellulaires denses, cellules fusiformes en **faisceaux courts entremêlés**
- Noyaux ovoïdes, anguleux, **inclusions intranucléaires**, alignement nucléaire formant les **nodules de Verocay**
...
|---------|------------------|
| **Plexiforme** | ~5%, multiples nodules encapsulés PS100+ |
| **Cellulaire** | Profond, femme, grande taille, Antoni A, atypies, mitoses possibles |
...
### Important
- **Pas de précurseur des MPNST** (sauf rares formes épithélioïdes malignes)
...
### Clinique
- **Solitaire sporadique** (90%) : superficiel, bien limité, **non encapsulé**, indolore
- **Multiples** = associés à la **NF1**
...
- Cellules à noyaux **sombres, onduleux**, prolongements étirés, **sans mitose**
- Clairsemées, avec mastocytes et lymphocytes
- Faisceaux de collagène plus épais possibles
...
### Traitement
- Exérèse simple si forme localisée
- **NF1** : prise en charge complexe (multiplicité, taille), **risque de transformation en MPNST**
...
### Clinique - 4 types
| Type | Siège | Population |
|------|-------|------------|
| **Intraneural** | Extrémités | Femme jeune |
| **Tissus mous** | Cutané/sous-cut/profond, extrémités > tronc | Femme âge moyen |
| **Muqueux** | Côlon++ | – |
...
### Histologie
- Cellularité variable : formes **myxoïde, sclérosante, réticulaire**
...
### Traitement
- Bénin, chirurgie simple suffisante, rares récidives
...
### Clinique
- Adulte, **prévalence féminine**
- Multiples dans **syndrome de Noonan**
- Sièges : **langue, sein, extrémités proximales**, sous-muqueuse digestive et respiratoire
...
- Noyau rond, sombre, peu atypique, non mitotique
...
## Diagnostics différentiels synthétiques

| Entité | Schwannome | Neurofibrome | Périneuriome | Cell. granuleuses |
|--------|-----------|--------------|--------------|-------------------|
| **S100** | +++ diffus | + hétérogène | − | + |
| **SOX10** | + | + | − | + |
| **EMA** | + (capsule) | − | + | − |
| **CD34** | faible | + focal | + | − |
| **GLUT1** | − | − | + | − |
...
1. **Schwannome** = encapsulé, **Antoni A (Verocay) + Antoni B**, **S100 +++ diffus**, SOX10+, perte **NF2/Merlin**
2. **Neurofibrome** = non encapsulé, trame myxoïde, noyaux onduleux, **S100+ hétérogène**, CD34+, perte **NF1/neurofibromine**
3. **Neurofibrome plexiforme = pathognomonique de NF1** et à risque de transformation en **MPNST**
4. **Périneuriome** = **S100 NÉGATIF**, **EMA+, CD34+, GLUT1+**, aspect feuilleté/bulbes d'oignon
5. **Tumeur à cellules granuleuses** : cellules polygonales granuleuses éosinophiles, **S100+, SOX10+, inhibine+, HMB45−**
6. Schwannomes multiples → évoquer **NF2** (vestibulaires bilatéraux), schwannomatose ou Carney (mélanocytiques)
7. Schwannomes anciens peuvent avoir des atypies dystrophiques et nécrose ischémique **sans être malins**
8. **Schwannome digestif** non encapsulé avec couronne lymphoïde → DD GIST (**CD117−/DOG1−**)
9. **Tumeurs hybrides** (OMS 2013) : combinaisons schwannome/périneuriome ou neurofibrome/schwannome
10. Ces tumeurs bénignes sont distinctes des **MPNST** (cf. fiche 99), mais neurofibrome plexiforme = lésion précurseur potentielle
