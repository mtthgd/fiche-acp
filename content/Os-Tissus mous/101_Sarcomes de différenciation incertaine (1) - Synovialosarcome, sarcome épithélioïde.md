---
tags: [anatomopathologie, ACP, tissu_mou, synovialosarcome, sarcome_epithelioide, SS18, SSX1, SSX2, SMARCB1, INI1, TLE1]
date: 2024
source: DES ACP - Cours d'appareil locomoteur et tissus mous
---

# Sarcomes de différenciation incertaine (1) — Synovialosarcome, sarcome épithélioïde

> Liens : [[102_Sarcomes de différenciation incertaine (2)]] | [[81_Classification moléculaire]] | [[82_Grade FNCLCC]] | [[80_CAT TM]]
...
### Généralités
- **< 10% des sarcomes des TM**
- **Adolescents et jeunes adultes** (> 50% des cas), tout âge possible
- Sites : **membres (sup/inf)** profonds, **près d'une articulation** ; tronc (15%), tête-cou (7%), viscères possibles
- **Souvent douloureux**
- Imagerie parfois trompeuse (bien limitée, croissance lente → erreur avec tumeur bénigne) ; **calcifications, remaniements kystiques**, parfois envahissement osseux
...
| Sous-type | Fréquence | Particularité |
|-----------|-----------|---------------|
| **Monophasique fusiforme** | **Le plus fréquent** | Cellules fusiformes en faisceaux |
...
- Faisceaux de longueurs variées, rarement en **banc de poisson**
- Noyaux **monomorphes**, ovalaires/allongés, chromatine fine, nucléole peu visible
- Cytoplasme pâle peu abondant
- Remaniements **myxoïdes** peu abondants
...
| Marqueur | Expression |
|----------|------------|
| **EMA** | **+** (plus souvent que cytokératines) — positivité même **focale = évocatrice** |
| Cytokératines | + (fort et diffus dans contingent épithélial du biphasique) |
| **CD34** | **−** (souligne vascularisation) — **différencie de TFS** |
...
- **Translocation t(X;18)(p11;q11)** → fusion **SS18–SSX1** (le plus souvent), parfois **SSX2**, rarement **SSX4**
- **> 95% des cas** et **spécifique**
...
- **Score de différenciation = toujours 3** → grade FNCLCC **≥ 2**
- Formes infracentimétriques = très bon pronostic ; enfants et localisations aux extrémités = bon pronostic
- **Survie globale 5 ans** : enfant **83%**, adulte **62%**
...
| Forme | Âge | Localisation | Topographie |
|-------|-----|--------------|-------------|
...
- **Couronne de cellules épithélioïdes/fusiformes + nécrose centrale** → **aspect pseudo-granulomateux**
...
- **Métastases 40-50%** après récurrences multiples
- **Métastases ganglionnaires** (fait notable pour un sarcome)
- **SG 5 ans : 60-80%** ; **SG 10 ans : 42-62%**
...
|-|----------------------|--------------------------|
| Âge | Ados/jeunes adultes | Distal 10-40, proximal 20-65 |
| Siège | Près articulations, profond | Distal : cutané mains ; Proximal : tronc profond |
| Morphologie | Biphasique / monophasique / peu différencié | Pseudo-granulomateux nécrotique / rhabdoïde |
| EMA/CK | + | + |
| CD34 | **−** | **+ (>50%)** |
| TLE1 | + (80%) | − |
| **INI1/SMARCB1** | Conservé | **Perdu** |
| Translocation | **t(X;18) SS18-SSX1/2/4** | Inactivation **SMARCB1** |

---

## 🔑 Points clés à retenir

1. **Synovialosarcome** : adolescent/jeune adulte, membres profonds proche articulation, **souvent douloureux** ; **< 10% sarcomes TM**
2. **3 sous-types** synovialosarcome : monophasique fusiforme (le plus fréquent), biphasique (épithélial + fusocellulaire), peu différencié
3. IHC synovialosarcome : **EMA+** (même focale évocatrice), **CK+**, **CD34 NÉGATIF** (DD TFS), **TLE1+** (sensible non spécifique)
4. Diagnostic moléculaire : **t(X;18) SS18–SSX1/SSX2** (> 95%, spécifique) — FISH break-apart SS18 ou RT-PCR
5. **Score de différenciation = 3** → grade FNCLCC **≥ 2** systématiquement
6. **Sarcome épithélioïde : 2 formes** — distale (cutanée, mains, jeune) et proximale (profonde, tronc, plus agressive)
7. Histologie distale : **aspect pseudo-granulomateux** avec nécrose centrale en carte de géographie
8. Histologie proximale : cellules épithélioïdes/**rhabdoïdes**, pléomorphes, nucléoles proéminents
9. IHC sarcome épithélioïde : **CK+, EMA+, CD34+ (>50%)**, **perte nucléaire INI1/SMARCB1/BAF47**
10. Sarcome épithélioïde : **métastases ganglionnaires** possibles (rare pour un sarcome) ; forme proximale de plus mauvais pronostic
