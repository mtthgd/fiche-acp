---
tags: [anatomopathologie, ACP, tissu_mou, rhabdomyosarcome, embryonnaire, alveolaire, pleomorphe, spindle_cell_sclerosing, PAX3_FOXO1, PAX7_FOXO1, desmine, myogenine, MYOD1]
date: 2024
...
> Liens : [[95_Tumeurs musculaires lisses]] | [[81_Classification moléculaire]] | [[82_Grade FNCLCC]] | [[56_Tumeurs de la famille Ewing]]

## Vue d'ensemble

**4 sous-types** de rhabdomyosarcome (RMS) :

| Sous-type | Fréquence | Âge typique | Génétique |
|-----------|-----------|-------------|-----------|
| **Embryonnaire** | Le + fréquent | **Enfant < 10 ans** | Aneuploïdie, gains/pertes |
| **Alvéolaire** | 2e plus fréquent | **Adolescent, adulte jeune** | **PAX3/PAX7-FOXO1** |
| **À cellules fusiformes / sclérosant** | Rare (10-15%) | Enfant et adulte | NCOA2, VGLL2, **MYOD1** |
| **Pléomorphe** | Très rare | **Adulte 60-70 ans** | Génomique complexe |

**IHC commune** (positivité variable selon différenciation) :
- **Desmine** : cytoplasmique
- **Myogénine** : nucléaire
- **MyoD1** : nucléaire (plus sensible dans formes non à cellules rondes)
...
## Généralités
- **Sarcome des tissus mous le plus fréquent chez l'enfant et l'adolescent**
- Au sein des RMS, **sous-type le plus fréquent**
- **Enfant < 10 ans ++**, peut être congénital
- **20% chez l'adulte** (rare)
- Contexte possible de **syndrome de prédisposition génétique**

## Localisations
- **Tête et cou (~50%)** : périorbitaire, nasopharynx
- **Système génito-urinaire (~50%)** : vessie, prostate, paratesticulaire
- **Rare aux extrémités**
- Autres : voies biliaires, pelvis, rétropéritoine, viscères
...
- **Densité cellulaire variable** : zones denses / zones peu cellulaires avec stroma myxoïde abondant
- **Aspect cytologique des rhabdomyoblastes variable** :
  - Petites cellules rondes/étoilées/fusiformes indifférenciées
  - **Cellules "têtards"** : cytoplasme éosinophile modéré
...
- **Myogénine** et **MyoD1** nucléaires : positifs, corrélés au degré de différenciation

## Variantes

### RMS botryoïde
- **Viscères tapissés d'un épithélium** (vessie, pharynx, conjonctive)
- Macro : tumeurs **polypoïdes**
...
## Généralités
- **Adolescent et jeune adulte** (tous âges possibles)
...
## Histologie
- Prolifération **dense de cellules monomorphes**
- **Architecture alvéolaire** : septas fibreux, cellules en **palissade** le long des septas, cellules **peu cohésives** au centre
- Formes **solides/diffuses** plus rares (nappes)
...
- **Plus mauvais pronostic que le RMS embryonnaire** → **intensification thérapeutique** justifiée
- **PAX7-FOXO1 meilleur pronostic** que PAX3-FOXO1
- **Mise en évidence du réarrangement indispensable au diagnostic ET au traitement**


---

# 3. Rhabdomyosarcome à cellules fusiformes / sclérosant

## Généralités
- **10-15% des RMS**
- **Enfant et adulte**, prédominance masculine
- Enfant : **région paratesticulaire** fréquemment
- Adulte : **tissus mous, tête et cou**
- Autres : rétropéritoine, viscères
...
# 4. Rhabdomyosarcome pléomorphe

## Généralités
- **Quasi exclusivement adulte 60-70 ans**
- Tissus mous des **membres inférieurs ++**
...
| | **Embryonnaire** | **Alvéolaire** | **Fusiforme/Sclérosant** | **Pléomorphe** |
|---|------------------|----------------|--------------------------|----------------|
| Âge | Enfant < 10 ans | Adolescent/adulte jeune | Enfant et adulte | Adulte 60-70 ans |
| Sites | **Tête/cou, génito-urinaire** | **Extrémités** | Paratesticulaire (enf.), TM (ad.) | Membres inf. |
| Histologie | Variable + rhabdomyoblastes têtards | Alvéolaire, cellules monomorphes | Fasciculée/storiforme | Pléomorphe |
| IHC myogénine/MyoD1 | + variable | **+ intense diffus** | MyoD1 > myogénine | + |
| Génétique | Aneuploïdie | **PAX3/PAX7-FOXO1** | NCOA2, VGLL2, **MYOD1** | **Complexe** |
| Pronostic | Meilleur (botryoïde +++, anaplasique péjoratif) | Mauvais | Bon enfant, mauvais adulte (MYOD1 péjoratif) | Mauvais |

---

## 🔑 Points clés à retenir

1. **4 sous-types de RMS** : embryonnaire, alvéolaire, à cellules fusiformes/sclérosant, pléomorphe
2. IHC commune : **desmine** (cytoplasmique), **myogénine + MyoD1** (nucléaires) — positivité variable selon différenciation
3. **Embryonnaire = le plus fréquent**, enfant < 10 ans, tête/cou et génito-urinaire, **pas d'anomalie spécifique** (aneuploïdie)
4. Variantes embryonnaires : **botryoïde** (polypoïde, couche cambiale, très bon pronostic) / **anaplasique** (mauvais pronostic)
5. **Alvéolaire** = adolescent/adulte jeune, **extrémités**, architecture alvéolaire + cellules en palissade
6. **Alvéolaire = PAX3/PAX7-FOXO1** — **biologie moléculaire indispensable** au diagnostic
7. PAX7-FOXO1 meilleur pronostic que PAX3-FOXO1 ; alvéolaire > embryonnaire en gravité
8. **Fusiforme/sclérosant** : NCOA2, VGLL2, **mutation MYOD1** (péjorative), MyoD1 plus sensible que myogénine en IHC
9. **Pléomorphe** = adulte âgé, **génomique complexe**, mauvais pronostic
10. Myogénine/MyoD1 **plus intenses** dans alvéolaire vs embryonnaire : aide au tri morphologique
