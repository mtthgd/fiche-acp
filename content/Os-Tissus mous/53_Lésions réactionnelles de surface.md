...
tags:
  ...
  - BPOP
  - Nora
  - fasciite_nodulaire_intra_osseuse
date: 2024
source: DES ACP - Cours d'appareil locomoteur et tissus mous
---

# Lésions réactionnelles de surface

> Liens : [[44_Tumeurs ostéoformatrices bénignes]] | [[45_Ostéosarcomes]] | [[40_Introduction à la pathologie osseuse tumorale - démarche diagnostique]] | [[92_Fasciite nodulaire, myosite ossifiante, fibromatoses]]

## Rappels sur le périoste

- Membrane **fibrovasculaire** à la surface de tous les os (sauf surfaces articulaires, os sésamoïdes, sites d'insertion tendineuse)
- Deux couches :
  - **Externe fibreuse** : fibroblastes, collagène de type I, pauci-cellulaire
  - **Interne cambiale** : cellules progénitrices à potentiel **ostéogénique** → réparation osseuse, réaction périostée
- Épaisseur variable (âge, topographie), plus épais en diaphyse


## Réaction périostée : principe général

Sous l'action de stimuli (traumatiques, inflammatoires, endocriniens, tumoraux) le périoste **prolifère** et forme **os et/ou cartilage**.
...
- Sujet **jeune**
- Post-**traumatisme mineur** (parfois non retrouvé)
- Siège : **phalanges proximales** mains et pieds +++
...
1. Tissu **fibroblastique** floride + cellules géantes, ostéoïde débutant et cartilage immature (stade inquiétant → piège diagnostique)
...
- **20-40 ans**, phalanges proximales et moyennes, plus rarement métacarpes/métatarses
- **Taille < 3 cm**
...
- **Coiffe cartilagineuse** irrégulière en surface
- **Ossification** sous-jacente, interface irrégulière (aspect de cal)
- Cartilage **cellulaire, floride**, chondrocytes volumineux mitotiques, **SANS hyperchromatisme**
...
### Généralités
- Considérée **néoplasique** : translocation équilibrée mise en évidence
- Mêmes sites que la périostite ossifiante floride

### Imagerie
- Lésion **exophytique**, mieux limitée, plaquée contre la corticale (intacte)
...
- Os plutôt central, cartilage périphérique (coiffe ébauchée)
- Cartilage **très cellulaire**, gros chondrocytes parfois binucléés atypiques mais non hyperchromatiques
- **Blue bone** : minéralisation **bleutée / violacée** typique à l'interface cartilage/os (os immature minéralisé)
...
- Peut être une forme **plus mature** de la périostite ossifiante floride / Nora
- Topographie : **face dorsale des phalanges** (périoste plus lâche)
- Radio : lésion étroite, bien démarquée, **base d'implantation large** minéralisée, **corticale intacte**, pas de continuité cortico-médullaire
...
### Généralités
- Sujet jeune, **gros orteil dans 81%** des cas > doigts de la main
...
- **Pédiculée** à sa base, posée sur la corticale
...
1. **Couche externe fibreuse** (sous le lit unguéal) : prolifération **myofibroblastique** fasciculée sans atypies → aspect de fasciite / périostite
...
- Exérèse chirurgicale complète (surinfections fréquentes)
- **Récidives 50%** si exérèse partielle

## Diagnostics différentiels clés

| DD | Points discriminants |
|----|----------------------|
| **Ostéosarcome de surface** | **Effraction corticale**, atypies marquées, os tumoral pléomorphe ; exceptionnel aux extrémités |
| **Ostéochondrome** | **Continuité cortico-médullaire** avec l'os porteur |
| **Myosite ossifiante** | Tissus mous, pas d'attache osseuse, architecture zonale (os mature en périphérie) |

---

## 🔑 Points clés à retenir

1. **4 lésions réactionnelles de surface** : périostite ossifiante floride, lésion de **Nora** (BPOP), exostose périostée acquise (turret), exostose sous-unguéale (Dupuytren)
2. Sièges préférentiels : **phalanges proximales** des mains et pieds (gros orteil pour Dupuytren)
3. Corticale **INTACTE** et **absence de continuité cortico-médullaire** = critères majeurs du DD
4. Aspect microscopique **floride, cellulaire, atypique** pouvant mimer un **ostéosarcome** → piège sur biopsie
5. **Blue bone** violacé à l'interface os/cartilage = signe caractéristique de la **lésion de Nora**
6. **Architecture zonale** (exostose sous-unguéale) : fibreuse - cartilagineuse - osseuse
7. **Séquence de maturation** analogue à la myosite ossifiante
8. Nora = **translocation équilibrée** ; Dupuytren = **t(X;6)** COL12A1/COL4A5 → nature néoplasique
9. Confrontation **radio-clinique systématique** pour redresser le diagnostic
10. Traitement : exérèse chirurgicale ; récidives fréquentes (50% pour Dupuytren) si exérèse incomplète
