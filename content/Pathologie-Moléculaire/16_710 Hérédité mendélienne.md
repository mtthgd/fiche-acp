...
tags:
  ...
  - hérédité
  - mendélien
  - autosomique_dominant
  - autosomique_récessif
  - lié_X
  - pénétrance
  - expressivité
  - mutations_dynamiques
date: 2024
...
> Liens : [[16_720 Notion d'hérédité]] | [[16_740 Introduction à la notion de polymorphisme et de mutation]] | [[16_760 ADN mitochondrial]] | [[16_770 Notions de cancers familiaux]] | [[16_210 Oncogènes et gènes suppresseurs de tumeurs]]

## Définitions / Bases

L’hérédité mendélienne regroupe les maladies monogéniques transmises selon les **trois lois de Mendel**. On distingue **trois grands modes** :

- **Autosomique dominant (AD)** : 1 allèle muté suffit
- **Autosomique récessif (AR)** : les 2 allèles doivent être mutés
- **Lié à l’X** (récessif, dominant ou semi-dominant)
...
### Principes
- Phénotype exprimé à l’**état hétérozygote** (1 seul chromosome porte la mutation)
- **Transmission verticale** (toutes les générations atteintes)
- Atteinte des **2 sexes** avec la même fréquence
...
|---------|------|---------|--------------|-----------------|
| **X fragile** | *FMR1* | **CGG** | 5’UTR | **> 200** |
| **Chorée de Huntington** | *HTT* | **CAG** | Exon | **> 36** |
| **Ataxie de Friedreich** | *FXN* | **GAA** | Intron | **> 200** |
| **Dystrophie myotonique de Steinert** | *DMPK* | **CTG** | 3’UTR | **> 50** |

**Corrélation génotype-phénotype dans la dystrophie de Steinert** (*DMPK*) :

| Nombre de répétés CTG | Phénotype |
|-----------------------|-----------|
| < 49 | Normal |
| **50-100** | DM peu sévère |
...
- **Mosaïcisme mixte** (embryon + placenta)
- **Mosaïcisme tissulaire** (confiné à certains organes)
...
### Principes
- Phénotype exprimé seulement si les **2 allèles sont mutés** :
  - **Homozygote** (même mutation, favorisé par **consanguinité**)
  - **Hétérozygote composite** (2 mutations différentes)
- Atteinte des **2 sexes** à fréquence égale
- **Transmission horizontale** (atteinte limitée à une fratrie)
...
| Mode | Atteinte | Caractéristiques |
|------|----------|------------------|
| **Récessif lié à l’X** | Garçons atteints, femmes vectrices | **Myopathie de Duchenne**, **hémophilie** |
| **Semi-dominant lié à l’X** | Hommes et femmes atteints | Femmes moins sévèrement atteintes |
| **Dominant lié à l’X** | Femmes atteintes, létalité chez le garçon | Pas de garçons vivants atteints |
| **Exception** | Maladie transmise par les garçons et n’atteignant que les femmes | Rare |

### Mécanisme transmissionnel — récessif lié à l’X

- **Mère conductrice (hétérozygote)** : 50 % des garçons hémizygotes (atteints), 50 % des filles vectrices
- **Père atteint** : aucun garçon malade, **toutes les filles vectrices**


## Cas particulier : transmission liée à l’Y
...
| Mode | Risque récidive | Sex-ratio | Transmission | Exemples |
|------|-----------------|-----------|--------------|----------|
| **AD** | **50 %** | M = F | Verticale | NF1, Huntington, Steinert |
| **AR** | **25 %** | M = F | Horizontale | Mucoviscidose, Wilson |
| **XR** | 50 % garçons | Garçons | Mère vectrice | Duchenne, hémophilie |
| **XD** | 50 % filles | Filles (létalité M) | Père/mère atteint | Rett, incontinentia pigmenti |
| **Y-lié** | 100 % garçons | Hommes | Père → fils | Très rare |

## 🔑 Points clés à retenir

1. **3 modes mendéliens** : autosomique dominant (AD), autosomique récessif (AR), lié à l’X (récessif/dominant/semi-dominant)
2. **AD** = transmission **verticale**, **50 %** de risque, expressivité variable, pénétrance incomplète possible
3. **AR** = transmission **horizontale**, **25 %** de risque, favorisée par la **consanguinité**, pénétrance complète
4. **Pénétrance incomplète** : porteur sain transmettant la maladie (AD)
5. **Expressivité variable** : même mutation, phénotypes différents (ex : **NF1**)
6. **Mutations *de novo*** : risque empirique de **mosaïque germinale ≈ 1 %**
7. **Phénomène d’anticipation** = aggravation par expansion de répétés en tandem = **mutations dynamiques** (Huntington **CAG > 36**, Steinert **CTG > 50**, X fragile **CGG > 200**)
8. **Mosaïcisme** post-zygotique : faible ou élevé, embryon/placenta/tissu spécifique
9. **Lié à l’X** : pas de transmission père → fils ; **inactivation de l’X** chez la femme
10. **Mucoviscidose** = AR la plus fréquente en France ; **Duchenne/hémophilie** = XR de référence
