...
# Carcinomes acineux et sécrétoires (MASC)

> Liens : [[50_Adénome pléomorphe]] | [[51_Tumeur de Warthin et kystes salivaires]] | [[52_Autres adénomes salivaires et contreparties malignes]] | [[60_Carcinome adénoïde kystique]] | [[61_Carcinome mucoépidermoïde]] | [[63_Autres carcinomes des glandes salivaires]] | [[41_Classification des tumeurs des glandes salivaires]]

## Généralités

Deux entités à distinguer depuis 2010 :

| Entité | Définition | Marqueur clé |
|--------|------------|--------------|
| **Carcinome à cellules acineuses** | Tumeur épithéliale maligne à **différenciation acineuse** (grains de zymogène), un seul contingent glandulaire | PAS-D+, **SOX10+, DOG1+ (apical)** |
| **Carcinome sécrétoire (MASC)** | Analogue salivaire du carcinome sécrétoire mammaire, **fusion ETV6–NTRK3** | **S100+ diffus, mammaglobine+ diffus**, DOG1− |
...
# PARTIE 1 : Carcinome à cellules acineuses

## Clinique / Épidémio

- **17 %** des tumeurs malignes des glandes salivaires
- **Deuxième tumeur maligne salivaire de l'enfant**
- Âge moyen **50 ans**, discrète prédominance féminine
- Siège : **parotide** ++ ; **5–10 % de paralysie faciale**

## Macroscopie

- Nodule **bien circonscrit**, **beige**, unique le plus souvent
- Contours légèrement polylobés
...
**Cellules acineuses** (tout carcinome à cellules acineuses = malin, même bien limité) :
- Grande taille polygonale, **cytoplasme basophile granuleux**
- **Grains de zymogène PAS + diastase résistants** ++
...
| Type cellulaire | Fréquence | Description |
|-----------------|:---:|------------|
| **Cellules claires / vacuolaires** | 1/3 | Alternent avec les cellules acineuses |
...
- Massive (souvent avec stroma lymphoïde à **follicules clairs**)
- **Microkystique**
...
| **S100** | **+** |
| **SOX10** | **+** |
| **DOG1** | **+** (pôle apical, pattern spécifique) |
| PAS-D | **+** (grains de zymogène) |
| Mammaglobine | − |
| Actine, P63, P40, CK5/6 (myoépithéliaux) | − |
| GFAP | − |

> ⚠ Discordance notable : **S100 + / PS1 −** (étonnant car habituellement concordants)

### DOG1 — pattern diagnostique
- Normalement : marquage du pôle apical des **acini normaux** en forme d'étoile à lumière infractueuse
- Sur carcinome : **renforcement apical** (pas de caractère stellaire ni infractueux)
...
- Rare mais grave
- Contingent dédifférencié à côté du contingent acineux classique
...
# PARTIE 2 : Carcinome sécrétoire (MASC)

## Historique

- Décrit en **2010 par Alena Skálová**
- Anciennement : *Mammary Analogue Secretory Carcinoma* (**MASC**)
- **Analogue du carcinome sécrétoire mammaire primitif** (translocation décrite en 2002)
- Renommé **carcinome sécrétoire** dans l'OMS 2017

## Clinique / Épidémio

- > 200 cas rapportés
- Âge moyen **≈ 50 ans** (8–82 ans)
- **Parotide** ++ ; **30 %** en glandes salivaires accessoires
- Tumeur de bas grade, mais quelques cas dédifférenciés/anaplasiques
- Métastases ganglionnaires **25 %**, viscérales exceptionnelles

## Histologie

- **Un seul type cellulaire** : cellules glandulaires épithéliales
- Cytoplasme **éosinophile abondant** avec **vacuoles optiquement vides** fines ou volumineuses
- Noyau clair ovale, petit nucléole
- **PAS intracellulaire négatif**, mais **sécrétion intraluminale PAS-D +** abondante
...
- **Kystique** ++ avec contenu liquidien, aspect peu infiltrant
- Folliculaire / microkystique
- Possibles projections papillaires
...
|----------|:---:|
| **S100** | **+++ diffus intense** |
| **Mammaglobine** | **+++ diffus intense** |
| CK7, CK19 | + (peu spécifique) |
| GCDFP-15, GATA3 | + |
| **DOG1** | **−** |
| Récepteurs hormonaux (ER, PR) | − |
...
- **Translocation t(12;15)(p13;q25) → fusion ETV6–NTRK3**
- **FISH break-apart ETV6** positive très constante
...
| DD | Distinction |
|----|-------------|
| **Carcinome à cellules acineuses (pauvre en grains)** | PAS-D grains +, **DOG1 apical +, S100 + / mammaglobine −** |
| **Adénocarcinome SAI** | Diagnostic d'élimination ; certains anciens « SAI » sont en fait MASC |
| **Carcinome mucoépidermoïde** | Bleu alcian intracytoplasmique +, 3 contingents, CRTC1/3–MAML2 |
...
- **Tout carcinome acineux pauvre en grains** → faire **S100 + mammaglobine**
- Si doubles positifs intenses → chercher **FISH ETV6** (confirmation)

---

## 🔑 Points clés à retenir

1. **Carcinome acineux** : tumeur salivaire à grains de **zymogène PAS-D +**, toujours maligne même bien limitée (17 % des tumeurs malignes salivaires, 2e maligne de l'enfant)
2. Parotide ++, **5-10 % de paralysie faciale**, stroma-réaction lymphocytaire fréquente
3. IHC : **S100+, SOX10+, DOG1+ apical**, **PAS-D grains +**, myoépithéliaux −
4. Discordance caractéristique : **S100 + / PS1 − / mammaglobine −**
5. Survie 90 % à 20 ans ; transformation anaplasique = pronostic réservé
6. **Carcinome sécrétoire (MASC)** : depuis 2010 (Skálová) ; **fusion ETV6–NTRK3**
7. Histologie : **un seul contingent**, cytoplasme vacuolaire, **sécrétion intraluminale PAS-D +**
8. IHC clé : **S100 + mammaglobine +** doubles et diffus, **DOG1 −**, P63 cytoplasmique possible
9. 10-20 % des anciens carcinomes acineux = carcinomes sécrétoires méconnus
10. **Intérêt thérapeutique** : inhibiteurs NTRK (**larotrectinib, entrectinib**) dans les cas métastatiques
