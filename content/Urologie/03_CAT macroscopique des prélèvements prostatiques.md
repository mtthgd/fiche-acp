...
# CAT macroscopique des prélèvements prostatiques

> Liens : [[02_Cancer prostate - histoire naturelle, schémas diagnostiques, thérapeutique]] | [[05_Compte rendu en pathologie prostatique]] | [[09_Facteurs pronostiques sur biopsies et résection prostatiques]] | [[01_Histologie normale de la prostate]]

## Généralités

Trois types de prélèvements prostatiques :
1. **Résection transurétrale de prostate (RTUP)** — traitement HBP
2. **Ponctions-biopsies** (PBP) — diagnostic CaP
...
2. **Inclure** les fragments non orientés : 2 à 5 g par cassette
3. **Jusqu'à 12 g** inclus systématiquement (≈ 6-8 cassettes)
4. Si matériel abondant : **1 cassette supplémentaire par 5 g** en plus
...
- **pT1b** : cancer sur **≥ 5 %** des copeaux

CaP de découverte fortuite sur RTUP = **< 20 %** des cas.


---

# 2. Ponctions-biopsies de prostate (PBP)

## Indications & renseignements cliniques obligatoires
- Augmentation du **PSA sérique**
- Âge, taux PSA, toucher rectal, échographie, **IRM** (PI-RADS), résultats biopsies antérieures


## Schéma de biopsie standard
- **Minimum 12 biopsies** (recommandations)
...
## Inclusion technique
- **Inclusion à plat** des carottes biopsiques (préserver la qualité)
...
- Exemple Lyon Sud : **lobe droit = vert**, **lobe gauche = noir**
...
- Pénétration formol = **1 mm/h** → **1-2 jours de fixation** pour prostate (organe plein)
- Injection intra-prostatique de formol possible pour accélérer

## Étape 4 — Pesée & mesure
...
Malgré l'inclusion totale, **≈ 10 % seulement de la surface** est réellement examiné. Zones-clés : **stade anatomique + marges chirurgicales**.


### Apex (conisation)
- Zone où la dissection est difficile → **marges fréquentes**
...
- Tranches complètes et régulières, **circonférence complète visible avec encre**
- De l'apex à la base
...
Contraintes :
- Peser sans vésicules séminales, mesurer 3 axes
- **Encrage obligatoire**
...
1. **RTUP** : peser, inclure **jusqu'à 12 g** systématiquement + 1 cassette/5 g supplémentaire.
2. Staging RTUP : **pT1a < 5 %** et **pT1b ≥ 5 %** des copeaux envahis.
3. **PBP** : minimum **12 biopsies** (base + corps + apex, D + G), idéalement **1 flacon/biopsie**.
4. Qualité biopsique : **longueur ≥ 10 mm**, inclusion **à plat**, **3 niveaux** avec lames blanches intermédiaires.
5. Prostatectomie : **conférence ISUP** → inclusion totale = **méthode de Stanford** (gold standard).
6. **Encrage bicolore** (1 par lobe), fixation formol **1-2 jours**.
7. **Apex + col vésical en conisation** : zones à haut risque de marges positives.
8. Vésicules séminales = **pT3b** → coupes transversales ou longitudinales.
9. Grandes coupes **perpendiculaires à l'urètre**, inclusion idéale en **méga-cassette**.
10. **Curage ganglionnaire** : ne jamais oublier, comptage + mesure + inclusion tissu adipeux si ganglions non palpables.
