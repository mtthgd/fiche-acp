...
# Naevus communs et dysplasiques

> Liens : [[08_1031_Approche Diagnostic Lesion Melan]] | [[08_1033_Naevus particuliers]] | [[08_1034_MelanomeOK]] | [[08_1035_Lésions MéInterprétation difficileOK]]

## Généralités

Un **naevus** = prolifération mélanocytaire **bénigne**. Attention en anglais, *nevus* signifie *hamartome* (donc *epidermal nevus* = hamartome épidermique, non mélanocytaire).

### Classifications
| Critère | Catégories |
|---------|------------|
| **Mode d'apparition** | Congénitaux vs **acquis** (majorité) |
| **Disposition histologique** | **Jonctionnel** / **composé** / **dermique** |
| **Topographie** | Cutanés, plis, acraux, génitaux, tronc, extra-cutanés (ganglion) |
| **Morphologie cytologique** | **Communs** (névocytes ronds, ovalaires, sans dendrite) vs spéciaux (bleu, Spitz...) |

### Histoire naturelle
- **< 3 %** des naevus sont congénitaux ; majorité **acquis**
- Poussée prépubertaire → capital naevique vers 20 ans
...
```
Peau normale → Lentigo simplex → Lentigo (début thèques)
            → Naevus jonctionnel pur → Naevus composé
...
Lésions variables : planes, tubéreuses, polypoïdes, verruqueuses, mollusciformes. Généralement pigmentées (mais pas toujours).

## Lentigo simplex

**Petite tache pigmentée** (1-5 mm) foncée.
...
|--------|---------------|
| **Éphélides** (taches de rousseur, *lentigines*) | Hyperpigmentation kératinocytaire seule, **pas de prolifération** mélanocytaire |
...
Défini par l'apparition de **thèques** (boules de mélanocytes). Mélanocytes **uniquement dans l'épiderme**.
...
Association : **composante jonctionnelle + composante dermique**.

### Critères clés
- **Activité jonctionnelle** : surtout thécale, parfois lentigineuse, thèques basées sur les crêtes
- **Gradient de maturation** : décroissance de la taille et de la pigmentation **du haut vers le bas** (≠ épithélium malpighien)
- **Grenz zone** : espace sous-épidermique sans mélanocytes
...
- Naevus commun **spontanément régressif**
- Enfant / adulte jeune, tronc, **halo achromique** clinique
- **Histologie** : lésion superficielle symétrique, infiltrat lymphocytaire **dense en bande** (phénotype T) pouvant simuler un pseudolymphome
- Naevus composé ou dermique (jamais purement épidermique)
- Activité jonctionnelle discrète, thèques monomorphes trapues, **pas de pagétoïde**
...
### Naevus récurrent / récidivant

- **Récidive trompeuse** d'un naevus retiré incomplètement (souvent par shaving)
- Adulte jeune, délai court entre exérèse initiale et récidive
- Ancien terme « pseudo-mélanome » (à abandonner)
- **Histologie** : contexte cicatriciel (fibrose dermique, vaisseaux verticalisés, manchons inflammatoires) + **reliquat névique** profond ou périannexiel
- Récidive intra-épidermique : **ne dépasse pas latéralement la cicatrice**
- Limites jonctionnelles nettes, lentigineuses ou thécales pléomorphes
...
- Adulte, visage
- Aspects dégénératifs : raréfaction cellulaire, fibrose, hyalinisation, hémorragie, œdème
- Mélanocytes parfois atypiques (pléomorphes, hyperchromatiques, nucléolés) avec inclusions nucléaires
...
- Sujet < 30 ans, tête / tronc, sans particularité clinique
- Grandes cellules **micro-vacuolisées**, noyau central, cytoplasme spumeux, **PAS+**
- **Pas d'atypie cellulaire**
- Anomalie de la synthèse de mélanine (pas un artefact)
...
### Définition
- Terme **histologique** ; pendant clinique = **naevus atypique** (isolé ou syndrome des naevus atypiques)
- Entité **floue, encore débattue**
- Naevus pris pour commun dans l'enfance qui **continue d'évoluer sur un mode jonctionnel** sans s'arrêter ; **jamais purement dermique**

### Épidémiologie / impact
- < 5 % de la population générale
- Jusqu'à **90 % des patients** atteints de **mélanome familial**
- **Marqueur de risque** d'évolution vers mélanome :
  - < 5 % des cas sporadiques
  - **Quasi-totalité** dans le contexte de mélanome familial
- Surveillance dermatologique régulière

### Clinique
- Acquis après la puberté, multiples
- Cuir chevelu, tronc, face, fesses
- **Grande taille** (élément le plus important), contours irréguliers, limites floues, couleurs multiples
- Peuvent satisfaire les critères ABCD des mélanomes superficiels

### Histologie
- Lésion de **grande taille** occupant la quasi-totalité de la pièce
- Disposition jonctionnelle ou composée (la composante dermique est **banale** si présente)
- **Hyperplasie lentigineuse** : prolifération individuelle de mélanocytes le long de la basale (comme dans le Dubreuilh ou l'ALM)
- Thèques **ovalaires, parfois horizontales**
- **Pontages inter-papillaires** entre crêtes épidermiques (non spécifiques : présents aussi dans naevus du tronc, naevus de Reed)
- **Stroma-réaction** : inflammation lymphocytaire, mélanophages, **fibrose éosinophile** lamellaire enserrant les thèques

#### Mélanocytes atypiques
- **Volontiers épithélioïdes**, volumineux, mélanine **poussiéreuse**, hyperchromatiques, noyaux nucléolés
- Doivent rester **minoritaires** et **cantonnés à la basale** (pas de pagétoïde)
- Si atypies nombreuses, sévères, **rassemblées** + pagétoïde + régression + inflammation en bande + mitoses profondes → **suspecter SSM**

---

## 🔑 Points clés à retenir

1. **Naevus = prolifération mélanocytaire bénigne** ; séquence : jonctionnel → composé → dermique
2. **Lentigo simplex** = mode lentigineux pur, **pas de thèques** ; ne pas confondre avec lentigo actinique (lésion épithéliale)
3. **Naevus jonctionnel** = thèques épidermiques exclusives ; **naevus composé** = épiderme + derme
4. **Gradient de maturation** dermique (haut → bas) = **critère majeur de bénignité**
5. **Halo-naevus de Sutton** : infiltrat lymphocytaire T en bande, naevus jamais purement épidermique
6. **Naevus récurrent** : reliquat névique sur cicatrice ; ne dépasse pas latéralement la cicatrice ; HMB45 garde un gradient
7. **Naevus dystrophique** : atypies cytologiques mais architecture organoïde conservée
8. **Naevus dysplasique = marqueur de risque** de mélanome (90 % des mélanomes familiaux)
9. **Histologie du dysplasique** : grande taille, hyperplasie lentigineuse, pontages, mélanocytes atypiques **minoritaires**, stroma-réaction fibreuse éosinophile
10. **DD majeur du dysplasique** : SSM si atypies sévères, pagétoïde, régression, mitoses profondes
