...
# Vascularites cutanées et classification de Chapel Hill

> Liens : [[08_311_Approche diagnostique dans les vasculopathies, commenté]] | [[08_314_Autres vascularites cutanées et vasculopathies thrombosantes, commenté]] | [[08_431_dermatoses lympho et plasmo V2]]

## Classification de Chapel Hill 2012 (actualisée)

Classification des **vascularites primitives** selon le **calibre des vaisseaux**.

### Vue d'ensemble

| Calibre | Vascularites | Visibles dans la peau ? |
|---------|--------------|:----------------------:|
| **Gros vaisseaux** | Maladie de **Horton**, **Takayasu** | **Non** (lésions secondaires ischémiques/écchymotiques possibles) |
| **Moyens vaisseaux** | **PAN** (péri-artérite noueuse), **Kawasaki** | Parfois (livedo, nodules) → biopsie **chirurgicale** |
| **Petits vaisseaux : ANCA** | **GPA** (Wegener), **GEPA** (Churg-Strauss), **MPA** (polyangéite microscopique) | **Oui** (artérioles dermohypodermiques) |
| **Petits vaisseaux : complexes immuns** | **Vascularite à IgA (Henoch-Schönlein)**, **cryoglobulinémique**, **urticarienne hypocomplémentémique (anti-C1q)**, **anti-MBG** | **Oui** (capillaires sup. ± profonds) |
...
| Vascularite | Capillaires sup. | Artérioles/vénules profondes |
|-------------|:----------------:|:---:|
| **Leucocytoclasique** / **purpura rhumatoïde (IgA)** | **++** | − |
| **ANCA** (GPA, GEPA, MPA) | + | **++** |
| **Cryoglobulinémique** / connectivites | + | **++** |
| **PAN** | − | **++** (moyen calibre, extension artériolaire hypodermique) |

## Vascularite leucocytoclasique (la plus fréquente)
...
- **Médicamenteuses** ++
- **Néoplasiques** (paranéoplasique, plus rare)
- **Connectivites** (lupus++)

### Histologie (variable selon stade et profondeur)

- **Infiltrat à PNN** péri- et intra-capillaire
- **Leucocytoclasie** (débris nucléaires de PNN)
- **Nécrose fibrinoïde** focale de la paroi
...
### DD important : dermatoses neutrophiliques
| DD | Distinction |
|----|-------------|
| **Pyoderma gangrenosum**, dermatose neutrophilique du dos des mains | Vascularite **accompagnatrice**, pas primitive |
| **Pathologies infectieuses** | Infiltrat plus polymorphe, agents pathogènes |
| **Hémopathies neutrophiliques** | Recrutement de PNN méloïdes/lymphoïdes |

## Vascularite urticarienne (spectre intermédiaire)

À cheval entre **urticaire** et **vascularite** (complexes immuns IgE pour l'urticaire).

### Clinique
- **Plaques œdémateuses migratrices**, expression purpurique modérée

### Histologie
- Infiltrat de PNN **dispersé** dans le derme (moins dense)
...
| Lésion associée | Évoque |
|-----------------|--------|
| **Pustules** | Infection / nécrose ischémique |
| **Granulomes extravasculaires + PNN** | **GPA (Wegener)** |
| **Polynucléaires éosinophiles** | **GEPA (Churg-Strauss)** |
| **Thromboses PAS+ pariétales** | **Cryoglobulinémie** (type I++) |
| **IFD : dépôts d'IgA** | **Purpura rhumatoïde / vascularite à IgA (HSP)** |
...
Atteinte des **artérioles/vénules** du derme profond et hypoderme.

### Entités principales

| Entité | Particularités |
|--------|----------------|
| **GPA (Wegener)** | Granulomes extravasculaires, **ANCA-c (anti-PR3)** |
| **GEPA (Churg-Strauss)** | Éosinophiles, **ANCA-p (anti-MPO)** ± |
| **MPA (polyangéite microscopique)** | Mime leucocytoclasique mais **IFD négative** (pas de complexes immuns) |
| **PAN classique** | Atteinte moyens vaisseaux |

### Diagnostic différentiel : **vascularite nodulaire / érythème induré de Bazin**
- Cause mystérieuse, autrefois liée à la **tuberculose**
...
1. **Dépôt fibrineux** + PNN dans la paroi
2. **Altération de la limitante élastique** (orcéine), infiltrat polymorphe
3. **Fibrose** + prolifération fibroblastique péricapillaire
4. **Endartérite fibreuse oblitérante** (stade tardif, infiltrat disparaît)
...
- Atteinte des petits vaisseaux du derme
- Mime parfois fortement la leucocytoclasique à complexes immuns
...
- **Oblitération + thrombose**
- Infiltrat à **PNN** + cellules mononucléées
- **Foyers de nécrose fibrinoïde**
...
| Vascularite | Calibre | Histologie clé | IFD | Spécificité |
|-------------|---------|----------------|-----|-------------|
| Leucocytoclasique | Capillaires sup. | PNN + leucocytoclasie + fibrinoïde | + (IgM/IgG/IgA, C3) | La + fréquente |
| **Purpura rhumatoïde (HSP)** | Capillaires sup. | Leucocytoclasique | **IgA ++** | Enfant, IgA dominant |
| Urticarienne | Capillaires sup. | PNN dispersés + œdème | +/− | Spectre urticaire |
| Cryoglobulinémique | Petits vx | Thromboses **PAS+** | + (clones Ig) | Monotypie (type I) |
| **GPA (Wegener)** | Petits → moyens | Granulomes + PNN + fibrinoïde | − | **ANCA-c (PR3)** |
| **GEPA (Churg-Strauss)** | Petits | Éosinophiles + granulomes | − | **ANCA-p (MPO)** ± |
| **MPA** | Petits | Mime leucocytoclasique | **−** ++ | ANCA-p (MPO) |
| **PAN** | Moyens | Infiltrat mononucléé + thrombose | − | Biopsie profonde |

## Diagnostics différentiels

| DD | Distinction |
|----|-------------|
| Pyoderma gangrenosum | Dermatose neutrophilique massive, vascularite secondaire |
| Dermatose neutrophilique du dos des mains | Vascularite accompagnatrice |
| Urticaire commune | Pas d'agression pariétale |
| Lupus | Connectivite, vascularite secondaire |
| Érythème induré de Bazin | Panniculite granulomateuse |

---

## 🔑 Points clés à retenir

1. **Chapel Hill 2012** classe les vascularites primitives par **calibre** : gros / moyens / petits / variable / mono-organe
2. La peau ne contient que des **petits vaisseaux** (Horton, Takayasu, Kawasaki = invisibles en biopsie cutanée)
3. **Vascularite leucocytoclasique** = la + fréquente, prototype de l'**hypersensibilité type III**
4. Histologie : **PNN + leucocytoclasie + nécrose fibrinoïde + extravasation érythrocytaire**
5. **IFD systématique** : recherche de **dépôts d'IgA** (purpura rhumatoïde / HSP / vascularite à IgA)
6. **MPA** mime la leucocytoclasique mais **IFD négative** (pas de complexes immuns)
7. **GPA (Wegener)** : granulomes extravasculaires + PNN + ANCA-c PR3
8. **GEPA (Churg-Strauss)** : éosinophiles + granulomes + ANCA-p MPO
9. **Cryoglobulinémie type I** : thromboses **PAS+ éosinophiles**, monotypie kappa/lambda
10. **PAN cutanée** : biopsie chirurgicale incisionnelle obligatoire pour atteindre les vaisseaux profonds — DD avec **érythème induré de Bazin** (panniculite granulomateuse)
